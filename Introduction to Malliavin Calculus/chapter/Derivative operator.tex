...
%\begin{theorem}
%Given $X \in \mathbb{D}^{1, 2}$ and $X \in \mathcal{F}_{T}$
%, then $X = \E[X] + \int_{0}^{T} \E[D_{t} X| \mathcal{F}_{t}] d W_t$. 
%\end{theorem}
%
%\begin{proof}
%The proof needs result from divergence operator, which is out of scope of this report. 
%\end{proof}
%
%\begin{remark}
%The above theorem can be treated as an analogy of 
